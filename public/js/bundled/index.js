      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'There is an error, Please try again');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZzB2aW4tZCIsImEiOiJja3ZrZHJ4ZW00cDd3MnJvazhhOHB0cnd2In0.pp_6nEjymRO26oPfChxhiQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            route = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:8000/api/v1/users/".concat(route),
              data: data
            });
...
var stripe = Stripe('pk_test_51KADQmSGBnwpt1NnVRxuN5xiU0lpiMKac6vwbXbUpR8AG2uuA0t3dBVCG9auUiNvwHQ4VjRye7Fex7q5PMprq01O00FAlux1qH');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) redirect to stripe payment
...
var formPasswordData = document.querySelector('.form-password-data');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // userData form
...
if (formPasswordData) {
  formPasswordData.addEventListener('submit', /*#__PURE__*/function () {
